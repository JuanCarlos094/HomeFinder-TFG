    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 d-flex justify-content-between align-items-center">
                <div>
                    <a href="{{ url('generate-pdf-clients') }}" class="btn btn-warning">Generar PDF de Clientes</a>
                </div>
                <div>
                    <a href="{{ route('admin.clientes.create') }}" class="btn btn-primary mr-2">Nuevo cliente</a>                </div>
            </div>
        </div>
    </div>
</div>
