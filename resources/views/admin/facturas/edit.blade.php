...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Editar Factura</h1>
            </div>
        </div>
    </div>
</div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.facturas.update', $factura->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="codigo_factura" id="codigo_factura" class="form-control {{ $errors->has('codigo_factura') ? 'is-invalid' : '' }}" placeholder="Ingrese el código de factura" value="{{ old('codigo_factura', $factura->codigo_factura) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="direccion" id="direccion" class="form-control {{ $errors->has('direccion') ? 'is-invalid' : '' }}" placeholder="Ingrese la dirección" value="{{ old('direccion', $factura->direccion) }}">
